...
function Cards() {
  ...
  hover:shadow-cyan-500/30 card mt-12 md:mt-[94px] shadow-[0_10px_15px_rgba(0,0,0,0.1)] w-full max-w-[350px] md:max-w-[350px] lg:max-w-[502px] min-h-[auto] md:h-auto lg:h-[377px] rounded-[15px] px-6 md:px-8 lg:pr-[30px] lg:pl-[30px] py-8 md:py-10 lg:pt-[39px] lg:pb-[39px]"
      >
        <div className="ml-0 md:ml-[-15px] flex flex-col md:flex-row items-center gap-4 md:gap-0">
          <img src="/main-imgs/Coleta-imgs/cards/casa.png" alt="🆔" className="w-12 md:w-auto" />
          <div>
        ...
        <div className="mt-6 md:mt-0">
          <div>
            <div className="flex items-center">
              <img className="w-8 md:w-[36px] h-8 md:h-[36px]" src="/main-imgs/Coleta-imgs/point.png" alt="" />
  ...
  hover:shadow-cyan-500/30 card mt-12 md:mt-[94px] shadow-[0_10px_15px_rgba(0,0,0,0.1)] w-full max-w-[350px] md:max-w-[350px] lg:max-w-[502px] min-h-[auto] md:h-auto lg:h-[377px] rounded-[15px] px-6 md:px-8 lg:pr-[30px] lg:pl-[30px] py-8 md:py-10 lg:pt-[39px] lg:pb-[39px]"
      >
        <div className="flex flex-col md:flex-row items-center mb-4 md:mb-[19px] gap-4 md:gap-0">
          <img src="/main-imgs/Coleta-imgs/cards/coracao.png" alt="🆔" className="w-12 md:w-auto" />
  ...
  hover:shadow-cyan-500/30 card mt-12 md:mt-[94px] shadow-[0_10px_15px_rgba(0,0,0,0.1)] w-full max-w-[350px] md:max-w-[350px] lg:max-w-[502px] min-h-[auto] md:h-auto lg:h-[377px] rounded-[15px] px-6 md:px-8 lg:pr-[30px] lg:pl-[30px] py-8 md:py-10 lg:pt-[39px] lg:pb-[39px]"
      >
        <div className="flex flex-col md:flex-row items-center mb-4 md:mb-[19px] gap-4 md:gap-0">
          <img src="/main-imgs/Coleta-imgs/cards/predio.png" alt="🆔" className="w-12 md:w-auto" />
          <div className="ml-0 md:ml-[19px]">
  ...
  hover:shadow-cyan-500/30 card mt-12 md:mt-[94px] shadow-[0_10px_15px_rgba(0,0,0,0.1)] w-full max-w-[350px] md:max-w-[350px] lg:max-w-[502px] min-h-[auto] md:h-auto lg:h-[377px] rounded-[15px] px-6 md:px-8 lg:pr-[30px] lg:pl-[30px] py-8 md:py-10 lg:pt-[39px] lg:pb-[39px]"
      >
        <div className="flex flex-col md:flex-row items-center mb-4 md:mb-[19px] gap-4 md:gap-0">
          <img src="/main-imgs/Coleta-imgs/cards/profile.png" alt="🆔" className="w-12 md:w-auto" />
          <div className="ml-0 md:ml-[19px]">
  ...
  hover:shadow-cyan-500/30 card mt-12 md:mt-[94px] shadow-[0_10px_15px_rgba(0,0,0,0.1)] w-full max-w-[350px] md:max-w-[350px] lg:max-w-[502px] min-h-[auto] md:h-auto lg:h-[377px] rounded-[15px] px-6 md:px-8 lg:pr-[30px] lg:pl-[30px] py-8 md:py-10 lg:pt-[39px] lg:pb-[39px]"
      >
        <div className="flex flex-col md:flex-row items-center mb-4 md:mb-[19px] gap-4 md:gap-0">
          <img src="/main-imgs/Coleta-imgs/cards/univers.png" alt="🆔" className="w-12 md:w-auto" />
          <div className="ml-0 md:ml-[19px]">
  ...
  hover:shadow-cyan-500/30 card mt-12 md:mt-[94px] shadow-[0_10px_15px_rgba(0,0,0,0.1)] w-full max-w-[350px] md:max-w-[350px] lg:max-w-[502px] min-h-[auto] md:h-auto lg:h-[377px] rounded-[15px] px-6 md:px-8 lg:pr-[30px] lg:pl-[30px] py-8 md:py-10 lg:pt-[39px] lg:pb-[39px]"
      >
        <div className="flex flex-col md:flex-row items-center mb-4 md:mb-[19px] gap-4 md:gap-0">
          <img src="/main-imgs/Coleta-imgs/cards/predioRoxo.png" alt="🆔" className="w-12 md:w-auto" />
          <div className="ml-0 md:ml-[19px]">
