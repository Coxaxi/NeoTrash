...
function Home() {
  return (
    <div className=" lg:mt-[4px] md:mt-[-25px] mt-0 bg-gradient-to-br from-[#F0FDF5] to-[#EFF9FB] pb-6 md:pb-12 pt-4 md:pt-6 flex flex-col lg:flex-row items-center justify-between px-4 md:px-8 lg:px-16 gap-8 lg:gap-0">
